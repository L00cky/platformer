...
{
    public partial class MenuButtonPlay : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Gui.IClickable
    {
        ...
        public MenuButtonPlay ()
        	: this(FlatRedBall.Screens.ScreenManager.CurrentScreen.ContentManagerName, true)
        {
        }
        public MenuButtonPlay (string contentManagerName)
        	: this(contentManagerName, true)
        {
        }
        public MenuButtonPlay (string contentManagerName, bool addToManagers)
        	: base()
        {
        ...
        public static void LoadStaticContent (string contentManagerName)
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("MenuButtonPlayStaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/menubuttonplay/gamebuttonsforguifree.png", ContentManagerName))
                {
                    registerUnload = true;
                }
                GameButtonsForGUIFREE = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/menubuttonplay/gamebuttonsforguifree.png", ContentManagerName);
            }
